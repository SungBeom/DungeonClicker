...
public class CharacterController : MonoBehaviour
{
    ...
    ArrayList CharacterPrefabs { get; } = new ArrayList();   // ArrayList 사용시 접근을 할수는 있으나 이게 효율적인가?
    ...
    {
        CharacterPrefabs.RemoveAt(selected);
    }
    ...
    {
        HpBar.GetComponent<Slider>().maxValue = Hp[selected];
        HpBar.GetComponent<Slider>().value = Hp[selected];
    }
